...
categories: philosophy artificial-intelligence machine-learning math programming
---
...
{% include figure.liquid path="assets/img/linreg/linear_regression_example.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
