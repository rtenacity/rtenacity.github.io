...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/chess-one/chess2.webp" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/chess-one/chess3.webp" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/chess-one/chess4.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
