...
{% include figure.liquid path="assets/img/hegel/dialectic1.excalidraw.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/hegel/dialectic2.excalidraw.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
