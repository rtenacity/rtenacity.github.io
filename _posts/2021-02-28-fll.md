...
{% include figure.liquid path="assets/img/fll/fll.webp" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/fll/fll2.webp" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>


Let’s look at the hardware:

<iframe src="https://player.vimeo.com/video/517806926"
        width="640"
        height="360"
        frameborder="0"
