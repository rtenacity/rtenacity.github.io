...
{% include figure.liquid path="assets/img/shm/graph1.excalidraw.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/shm/graph2.excalidraw.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/shm/image.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
...
<div style="max-width: 50%; margin: auto;">
{% include figure.liquid path="assets/img/shm/image2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
</div>
